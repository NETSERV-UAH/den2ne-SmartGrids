...
function plotDeltaLoads(delta)
    ...
    data_table = readtable(strcat("csv/outdata_d",num2str(delta),".csv"), 'NumHeaderLines',1);
    ...
    strPath = strcat('fig/powerBalance_d', num2str(delta));
    ...
    pos = get(h,'Position');
    set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
    strPath2 = strcat('fig/powerAbsflux_d', num2str(delta));
    ...
    pos = get(h,'Position');
    set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
    strPath3 = strcat('fig/powerLoss_d', num2str(delta));
    ...
    pos = get(h,'Position');
    set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
    strPath4 = strcat('fig/powerLossCap_d', num2str(delta));
